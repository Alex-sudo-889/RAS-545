...
theta_offsets = [0, 270, 0, 0, -90];  % Adjust theta2 by 270 degrees, theta5 by -90 degrees

% Define a global XYZ offset for the base of the robot
global_base_offset = [0, 0, 200];  % Example offset for the base (X, Y, Z)
...
for i = 1:size(joint_data, 1)
    ...
    % Apply global base offset to calculated positions
    calc_X = calc_X + global_base_offset(1);
    calc_Y = calc_Y + global_base_offset(2);
    calc_Z = calc_Z + global_base_offset(3);
    ...
    % Apply global base offset to all joints
    X = [0, P1(1), P2(1), P3(1), P4(1), P5(1)] + global_base_offset(1);
    Y = [0, P1(2), P2(2), P3(2), P4(2), P5(2)] + global_base_offset(2);
    Z = [0, P1(3), P2(3), P3(3), P4(3), P5(3)] + global_base_offset(3);
